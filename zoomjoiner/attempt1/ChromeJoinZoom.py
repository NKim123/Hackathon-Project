...
def JoinZoom(link, username, password):
    ...
    optionss.add_argument('controlled')
    optionss.add_argument('disable-notifications')
    optionss.add_experimental_option("excludeSwitches", ['enable-automation'])
    
    browser = webdriver.Chrome("C:/Users/noahk/Documents/GitHub/Hackathon-Project/zoomjoiner/attempt1/chromedriver", options=optionss)
